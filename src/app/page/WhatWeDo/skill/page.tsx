    ...
    <section className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-12 max-w-4xl mx-auto">
        <p className="text-xl font-bold sm:text-lg">
          Every two years, we gather all of the kids from every home across
          Cambodia to meet in one common location, usually at Siem Reap or the
          beach. For 3 days, the kids participate in a wonderful camp that
          teaches them more about Jesus. The last Kid&#39;s Camp, in 2023, was
          held at a beautiful 4-star hotel, and over 700 people attended. It was
          an incredible experience for the kid.
        </p>
      </div>
      ...
      />
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <p className="text-lg text-gray-700">
            Internship in America: SEAPC has created an opportunity for students who graduate from university and wish
            to serve in the NGO. The internship lasts for 3 months.
          </p>

          <p className="text-lg text-gray-700">
            For three months they train in bible, leadership, finance, business, English, and more about NGO operations.
            When they complete the program, they will be immediately employed by SEAPC to work in Cambodia to help
