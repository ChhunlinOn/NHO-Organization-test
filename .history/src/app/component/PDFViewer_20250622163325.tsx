...
export default function PDFFlipViewer({ filePath }: PDFFlipViewerProps) {
  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen p-4 bg-gradient-to-r from-slate-100 to-slate-200">
      <div
        ref={containerRef}
        className="w-full max-w-6xl bg-white rounded-2xl shadow-xl p-4 sm:p-6 transition-all duration-300"
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 w-full">
          <button
            ...
            className="w-full sm:w-auto px-6 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded disabled:bg-gray-300 disabled:cursor-not-allowed"
          >
            ⬅ Previous
          </button>
