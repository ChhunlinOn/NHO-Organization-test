    ...
    <div className="flex flex-col items-center w-full min-h-screen p-2 box-border relative">
      <div className="w-full max-w-[720px] mb-2">
        <button
          ...
          className="flex items-center gap-1 px-2 py-1 sm:px-3 sm:py-2 rounded-md bg-gray-200 hover:bg-gray-300 transition-colors text-sm sm:text-base text-gray-700"
      ...
      {isOverlayOpen && (
        ...
        >
          <div className="relative w-[90vw] h-[90vh] sm:w-[80vw] sm:h-[80vh] max-w-[900px] max-h-[1200px]">
            <iframe
              src="/chhunlin.pdf"
            ...
            <button
              onClick={toggleOverlay}
              className="absolute top-[-40px] right-0 p-1 sm:p-2 rounded-full bg-gray-200 hover:bg-gray-300 transition-colors"
