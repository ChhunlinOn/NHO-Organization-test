    ...
    >
      {numPages && (
        <HTMLFlipBook
          ...
          flippingTime={250} // FURTHER DECREASED for a snappier, more realistic flip
          ...
          maxShadowOpacity={0.1} // Keep this for a subtle shadow, or adjust slightly if needed
          swipeDistance={30} // Keep a reasonable swipe distance
