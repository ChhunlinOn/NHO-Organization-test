...
interface RenderPdfPageToImageParams {
...
const renderPdfPageToImage = useCallback(
    async (
        ...
        pageNum: number
            ...
            const page: pdfjs.PDFPageProxy = await pdfDocument.getPage(pageNum);
            ...
            await page.render({ canvasContext: context as CanvasRenderingContext2D, viewport: viewport }).promise;
