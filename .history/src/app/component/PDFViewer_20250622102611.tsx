  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen p-2 box-border relative">
      ...
      {isOverlayOpen && (
        ...
        >
          <div className="relative w-full h-full max-w-[90vw] max-h-[90vh] sm:max-w-[80vw] sm:max-h-[80vh] bg-white">
            <iframe
              src="/chhunlin.pdf"
      ...
      <style jsx>{`
        ...
        .relative {
          aspect-ratio: 3 / 4; /* Adjust based on PDF aspect ratio, e.g., A4 is ~1:1.414 */
        }
