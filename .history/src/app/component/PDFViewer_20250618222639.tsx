...
export default function PDFFlipViewer() {
  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen p-2 box-border">
      <div className="w-full max-w-[720px] flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <button
          onClick={goToPreviousPage}
          disabled={currentPage === 1}
          className={`p-2 rounded-full bg-gray-200 hover:bg-gray-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors sm:order-1 order-2 self-center ${
        ...
        <div className="page-wrapper w-full sm:order-2 order-1" style={{ overflow: "hidden" }}>
          <Document
            file="/chhunlin.pdf"
        ...
        <button
          ...
          className={`p-2 rounded-full bg-gray-200 hover:bg-gray-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors sm:order-3 order-3 self-center ${
