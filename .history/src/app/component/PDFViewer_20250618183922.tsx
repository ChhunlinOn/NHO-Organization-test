    ...
    >
      {numPages && (
        <HTMLFlipBook
          ...
          flippingTime={400} // DECREASED: Make the flip animation faster (e.g., 400ms)
          ...
          maxShadowOpacity={0.1} // [Optional] Max shadow opacity (0-1) - you kept this for shadow
          swipeDistance={30} // INCREASED: Set a minimum swipe distance to trigger the flip (e.g., 30px)
