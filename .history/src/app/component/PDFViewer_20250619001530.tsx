  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen p-2 box-border relative">
      ...
      <button
        ...
        className="mt-2 p-1 sm:p-2 rounded-full bg-gray-200 hover:bg-gray-300 transition-colors"
      ...
      {isOverlayOpen && (
        ...
        >
          <iframe
            src="/chhunlin.pdf"
            className="w-[90vw] h-[90vh] sm:w-[80vw] sm:h-[80vh] max-w-[900px] max-h-[1200px] border-0"
            title="Full PDF View"
