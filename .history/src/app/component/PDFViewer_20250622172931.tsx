      ...
      {isZoomOpen && (
        <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4">
          <div className="relative w-full max-w-6xl h-[90vh] bg-white rounded-lg shadow-lg overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-auto p-4 flex justify-center items-center select-none">
              <div
                onClick={
                  () => setZoomScale((prev) => (prev >= 2 ? 1 : prev + 0.5)) // Toggle zoom
                }
                className="cursor-zoom-in transition duration-300"
                style={{
