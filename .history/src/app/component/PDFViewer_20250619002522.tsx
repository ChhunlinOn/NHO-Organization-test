    ...
    <div className="flex flex-col items-center w-full min-h-screen p-2 box-border relative">
      <div className="w-full max-w-[720px] mb-2">
        <button
          ...
          className="flex fl items-center gap-1 px-2 py-1 sm:px-3 sm:py-2 rounded-md bg-gray-200 hover:bg-gray-300 transition-colors text-sm sm:text-base text-gray-700"
